...
<script>
    ...
    function setSendData(){
        ...
        for(let validValue of values){
            if(validValue.attr('name') == 'recruitLocation'){
        		...
        		console.log(validValue.attr('id'));
        		formData.append(validValue.attr('id'), validValue.val());	
        		console.log(validValue.val());
        	}
        }
    ...
    function makeRecommMap(userCoordination){
        console.log('makemap'+userCoordination);
        ...
        if(status === kakao.maps.services.Status.OK){
            for(var i=0; i<date.length; i++){
                ...
                if(recommAddr.includes(userDeatilAddr)){
                    console.log('userDeatilAddr:'+userDeatilAddr);
                    var locationInfo = {};
