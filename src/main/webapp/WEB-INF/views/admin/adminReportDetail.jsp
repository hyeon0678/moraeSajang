...
<body>
    ...
    <div style="width: 1000px; height: 80px;">
        <textarea style="height:70px; width:850px; resize: none; float: left;" placeholder="내용을 입력 해 주세요." value=""></textarea>        
        <!-- <input type="text" id = "reporthistory" value="" placeholder="내용을 입력 해 주세요"></div> -->
     <div style="width: 100px; height:25px; float:right;"><input type="checkbox" value="처리완료">처리완료</div>
     <div style="width: 100px; height:25px; float:right;"><button onclick="">저장</button></div>	
    </div>
